      ...
      <Card className="w-full max-w-sm gap-4">
        ...
        <CardContent>
          <ItemGroup className="gap-0">
            {items.map((item) => (
              <Item key={item.name} size="xs" asChild className="px-0 group-hover/item-group:bg-transparent">
                <a href="#">
...
const environments = ["All Environments", "Production", "Preview", "Development", "Staging", "Test", "Other"]
...
const agentFeatures = [
  {
    ...
    content: (
      <>
        <strong>Code reviews</strong> with full codebase context to catch <strong>hard-to-find</strong> bugs. bugs.
      </>
    ),
  },
  {
        ...
        <DialogContent showCloseButton={false}>
          ...
          <div className="no-scrollbar flex max-h-[50vh] flex-col gap-4 overflow-y-auto">
            ...
            <Alert className="hidden sm:grid">
              ...
              <AlertDescription>Pro teams get $100 in Vercel Agent trial credit for 2 weeks.</AlertDescription>
            </Alert>
          </div>
          <DialogFooter>
            <DialogClose asChild>
  ...
  return (
    <Example title="Observability" className="items-center justify-center">
      <Card className="relative w-full max-w-md overflow-hidden pt-0">
        ...
        <CardFooter>
          <Button>
            Create Query <HugeiconsIcon icon={PlusSignIcon} strokeWidth={2} data-icon="inline-end" />
          </Button>
