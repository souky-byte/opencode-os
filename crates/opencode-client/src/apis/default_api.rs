...
pub async fn app_agents(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<Vec<models::Agent>, Error<AppAgentsError>> {
...
pub async fn app_log(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
    app_log_request: Option<models::AppLogRequest>,
) -> Result<bool, Error<AppLogError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn auth_set(
    ...
    provider_id: &str,
    directory: Option<&str>,
    auth: Option<models::Auth>,
) -> Result<bool, Error<AuthSetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        providerID = crate::apis::urlencode(p_path_provider_id)
    );
...
pub async fn command_list(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<Vec<models::Command>, Error<CommandListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn config_get(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<models::Config, Error<ConfigGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn config_providers(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<models::ConfigProviders200Response, Error<ConfigProvidersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
) -> Result<models::Config, Error<ConfigUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn event_subscribe(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<models::Event, Error<EventSubscribeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn file_list(
    ...
    path: &str,
    directory: Option<&str>,
) -> Result<Vec<models::FileNode>, Error<FileListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn file_read(
    ...
    path: &str,
    directory: Option<&str>,
) -> Result<models::FileContent, Error<FileReadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_path = path;
    let p_query_directory = directory;
...
pub async fn file_status(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<Vec<models::File>, Error<FileStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn find_files(
    ...
    r#type: Option<&str>,
    limit: Option<i32>,
) -> Result<Vec<String>, Error<FindFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn find_symbols(
    ...
    query: &str,
    directory: Option<&str>,
) -> Result<Vec<models::Symbol>, Error<FindSymbolsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_query = query;
    let p_query_directory = directory;
...
pub async fn find_text(
    ...
    pattern: &str,
    directory: Option<&str>,
) -> Result<Vec<models::FindText200ResponseInner>, Error<FindTextError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn formatter_status(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<Vec<models::FormatterStatus>, Error<FormatterStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn global_dispose(
    configuration: &configuration::Configuration,
) -> Result<bool, Error<GlobalDisposeError>> {
...
pub async fn global_event(
    configuration: &configuration::Configuration,
) -> Result<models::GlobalEvent, Error<GlobalEventError>> {
...
pub async fn global_health(
    configuration: &configuration::Configuration,
) -> Result<models::GlobalHealth200Response, Error<GlobalHealthError>> {
...
pub async fn instance_dispose(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<bool, Error<InstanceDisposeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn lsp_status(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<Vec<models::LspStatus>, Error<LspStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn mcp_add(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
    mcp_add_request: Option<models::McpAddRequest>,
) -> Result<std::collections::HashMap<String, models::McpStatus>, Error<McpAddError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn mcp_auth_authenticate(
    ...
    name: &str,
    directory: Option<&str>,
) -> Result<models::McpStatus, Error<McpAuthAuthenticateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn mcp_auth_callback(
    ...
    name: &str,
    directory: Option<&str>,
    mcp_auth_callback_request: Option<models::McpAuthCallbackRequest>,
) -> Result<models::McpStatus, Error<McpAuthCallbackError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_query_directory = directory;
...
pub async fn mcp_auth_remove(
    ...
    name: &str,
    directory: Option<&str>,
) -> Result<models::McpAuthRemove200Response, Error<McpAuthRemoveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_query_directory = directory;
...
pub async fn mcp_auth_start(
    ...
    name: &str,
    directory: Option<&str>,
) -> Result<models::McpAuthStart200Response, Error<McpAuthStartError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_query_directory = directory;
...
pub async fn mcp_connect(
    ...
    name: &str,
    directory: Option<&str>,
) -> Result<bool, Error<McpConnectError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_query_directory = directory;
...
pub async fn mcp_disconnect(
    ...
    name: &str,
    directory: Option<&str>,
) -> Result<bool, Error<McpDisconnectError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_query_directory = directory;
...
pub async fn mcp_status(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<std::collections::HashMap<String, models::McpStatus>, Error<McpStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn part_delete(
    configuration: &configuration::Configuration,
    session_id: &str,
    message_id: &str,
    part_id: &str,
    directory: Option<&str>,
) -> Result<bool, Error<PartDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        partID = crate::apis::urlencode(p_path_part_id)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn part_update(
    configuration: &configuration::Configuration,
    session_id: &str,
    message_id: &str,
    part_id: &str,
    directory: Option<&str>,
    part: Option<models::Part>,
...
pub async fn path_get(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<models::Path, Error<PathGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn permission_list(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<Vec<models::Permission>, Error<PermissionListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn permission_respond(
    ...
    permission_id: &str,
    directory: Option<&str>,
    permission_respond_request: Option<models::PermissionRespondRequest>,
) -> Result<bool, Error<PermissionRespondError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
...
pub async fn project_current(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<models::Project, Error<ProjectCurrentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn project_list(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<Vec<models::Project>, Error<ProjectListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn project_update(
    ...
    project_id: &str,
    directory: Option<&str>,
    project_update_request: Option<models::ProjectUpdateRequest>,
) -> Result<models::Project, Error<ProjectUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn provider_auth(
    ...
    std::collections::HashMap<String, Vec<models::ProviderAuthMethod>>,
...
pub async fn provider_list(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<models::ProviderList200Response, Error<ProviderListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn provider_oauth_authorize(
    ...
    provider_id: &str,
    directory: Option<&str>,
    provider_oauth_authorize_request: Option<models::ProviderOauthAuthorizeRequest>,
) -> Result<models::ProviderAuthAuthorization, Error<ProviderOauthAuthorizeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_provider_id = provider_id;
    let p_query_directory = directory;
...
pub async fn provider_oauth_callback(
    ...
    provider_id: &str,
    directory: Option<&str>,
    provider_oauth_callback_request: Option<models::ProviderOauthCallbackRequest>,
) -> Result<bool, Error<ProviderOauthCallbackError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_provider_id = provider_id;
    let p_query_directory = directory;
...
pub async fn pty_connect(
    ...
    pty_id: &str,
    directory: Option<&str>,
) -> Result<bool, Error<PtyConnectError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        "{}/pty/{ptyID}/connect",
        configuration.base_path,
        ptyID = crate::apis::urlencode(p_path_pty_id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn pty_create(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
    pty_create_request: Option<models::PtyCreateRequest>,
) -> Result<models::Pty, Error<PtyCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn pty_get(
    ...
    pty_id: &str,
    directory: Option<&str>,
) -> Result<models::Pty, Error<PtyGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pty_id = pty_id;
    let p_query_directory = directory;
...
pub async fn pty_list(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<Vec<models::Pty>, Error<PtyListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn pty_remove(
    ...
    pty_id: &str,
    directory: Option<&str>,
) -> Result<bool, Error<PtyRemoveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pty_id = pty_id;
    let p_query_directory = directory;
...
pub async fn pty_update(
    ...
    pty_id: &str,
    directory: Option<&str>,
    pty_update_request: Option<models::PtyUpdateRequest>,
) -> Result<models::Pty, Error<PtyUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pty_id = pty_id;
    let p_query_directory = directory;
...
pub async fn session_abort(
    ...
    session_id: &str,
    directory: Option<&str>,
) -> Result<bool, Error<SessionAbortError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_command(
    ...
    session_id: &str,
    directory: Option<&str>,
    session_command_request: Option<models::SessionCommandRequest>,
) -> Result<models::SessionPrompt200Response, Error<SessionCommandError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_create(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
    session_create_request: Option<models::SessionCreateRequest>,
) -> Result<models::Session, Error<SessionCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn session_delete(
    ...
    session_id: &str,
    directory: Option<&str>,
) -> Result<bool, Error<SessionDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
) -> Result<Vec<models::FileDiff>, Error<SessionDiffError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_fork(
    ...
    session_id: &str,
    directory: Option<&str>,
    session_fork_request: Option<models::SessionForkRequest>,
) -> Result<models::Session, Error<SessionForkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_init(
    ...
    session_id: &str,
    directory: Option<&str>,
    session_init_request: Option<models::SessionInitRequest>,
) -> Result<bool, Error<SessionInitError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_list(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<Vec<models::Session>, Error<SessionListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn session_message(
    ...
    message_id: &str,
    directory: Option<&str>,
) -> Result<models::SessionMessages200ResponseInner, Error<SessionMessageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_path_message_id = message_id;
    let p_query_directory = directory;
...
pub async fn session_messages(
    ...
    directory: Option<&str>,
    limit: Option<f64>,
) -> Result<Vec<models::SessionMessages200ResponseInner>, Error<SessionMessagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
    let p_query_limit = limit;
...
pub async fn session_prompt(
    ...
    session_id: &str,
    directory: Option<&str>,
    session_prompt_request: Option<models::SessionPromptRequest>,
) -> Result<models::SessionPrompt200Response, Error<SessionPromptError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_prompt_async(
    ...
    directory: Option<&str>,
    session_prompt_request: Option<models::SessionPromptRequest>,
) -> Result<(), Error<SessionPromptAsyncError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
    let p_body_session_prompt_request = session_prompt_request;
...
pub async fn session_revert(
    ...
    session_id: &str,
    directory: Option<&str>,
    session_revert_request: Option<models::SessionRevertRequest>,
) -> Result<models::Session, Error<SessionRevertError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_share(
    ...
    session_id: &str,
    directory: Option<&str>,
) -> Result<models::Session, Error<SessionShareError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_shell(
    ...
    session_id: &str,
    directory: Option<&str>,
    session_shell_request: Option<models::SessionShellRequest>,
) -> Result<models::AssistantMessage, Error<SessionShellError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_status(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<std::collections::HashMap<String, models::SessionStatus>, Error<SessionStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn session_summarize(
    ...
    session_id: &str,
    directory: Option<&str>,
    session_summarize_request: Option<models::SessionSummarizeRequest>,
) -> Result<bool, Error<SessionSummarizeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_todo(
    ...
    session_id: &str,
    directory: Option<&str>,
) -> Result<Vec<models::Todo>, Error<SessionTodoError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_unrevert(
    ...
    session_id: &str,
    directory: Option<&str>,
) -> Result<models::Session, Error<SessionUnrevertError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_unshare(
    ...
    session_id: &str,
    directory: Option<&str>,
) -> Result<models::Session, Error<SessionUnshareError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn session_update(
    ...
    session_id: &str,
    directory: Option<&str>,
    session_update_request: Option<models::SessionUpdateRequest>,
) -> Result<models::Session, Error<SessionUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_session_id = session_id;
    let p_query_directory = directory;
...
pub async fn tool_ids(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<Vec<String>, Error<ToolIdsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tool_list(
    ...
    model: &str,
    directory: Option<&str>,
) -> Result<Vec<models::ToolListItem>, Error<ToolListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn tui_append_prompt(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
    find_text200_response_inner_path: Option<models::FindText200ResponseInnerPath>,
) -> Result<bool, Error<TuiAppendPromptError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tui_clear_prompt(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<bool, Error<TuiClearPromptError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tui_control_next(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<models::TuiControlNext200Response, Error<TuiControlNextError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
) -> Result<bool, Error<TuiControlResponseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tui_execute_command(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
    tui_execute_command_request: Option<models::TuiExecuteCommandRequest>,
) -> Result<bool, Error<TuiExecuteCommandError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tui_open_help(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<bool, Error<TuiOpenHelpError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tui_open_models(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<bool, Error<TuiOpenModelsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tui_open_sessions(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<bool, Error<TuiOpenSessionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tui_open_themes(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<bool, Error<TuiOpenThemesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tui_publish(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
    tui_publish_request: Option<models::TuiPublishRequest>,
) -> Result<bool, Error<TuiPublishError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tui_show_toast(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
    tui_show_toast_request: Option<models::TuiShowToastRequest>,
) -> Result<bool, Error<TuiShowToastError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn tui_submit_prompt(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<bool, Error<TuiSubmitPromptError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
...
pub async fn vcs_get(
    configuration: &configuration::Configuration,
    directory: Option<&str>,
) -> Result<models::VcsInfo, Error<VcsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_directory = directory;
