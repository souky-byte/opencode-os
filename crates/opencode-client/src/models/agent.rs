...
impl Agent {
    pub fn new(name: String, mode: Mode, permission: models::AgentPermission, tools: std::collections::HashMap<String, bool>, options: std::collections::HashMap<String, serde_json::Value>) -> Agent {
        Agent {
            name,
            description: None,
            mode,
